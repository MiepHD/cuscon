...
process_request() {
    ...
    echo "- should have approximately (±6px) 15px transparent border on two opposite sides"
    echo "- the other two sides should have apporximately 15px transparent border ${GREEN}or more${NC}"
    echo -e "- The black border should be approximately ${GREEN}6px thick${NC}"
    echo -e "To get a graphic example look at the file /sample_icon.webp"
    echo ""
